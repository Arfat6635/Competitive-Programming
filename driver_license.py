...
then an integer of the number of available agents, and lastly a string of the other four names separated by spaces.
...
print(20*((names.index(my_name))//agents)+20)


'''
each agent see one customer at a time

divide the customer ratio by number of agents
'''